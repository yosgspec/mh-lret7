<template>
<div>
	<div id=nav-button @click="navChange"><span>{{navMark}}</span></div>
	<div id=navMenu	:class="{navDisp:isDisp,navHide:!isDisp}">
		<div>
		...
		<div>
			<router-link to="/readme/" title="ルーレットについて" @click.native="scrollTop()">ルーレットについて</router-link>{{" "}}
			<span>ルーレット:</span>
			...
			<router-link to="/" title="MHWIルーレットVE" @click.native="scrollTop()">MHWI</router-link>
			<a href="/lret/mhwi-br/" title="MHWIルーレットBR">(BR)</a>{{" "}}
...
export default class NavMenu extends Vue{
	private isDisp=false;
	private get navMark():string{return this.isDisp? "✘": "≡";}

	private get lastUpdate():string{
		var d=store.state.lastUpdate;
